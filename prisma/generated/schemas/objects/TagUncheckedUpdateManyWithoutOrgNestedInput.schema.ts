...
const Schema: z.ZodType<Prisma.TagUncheckedUpdateManyWithoutOrgNestedInput> = z
  .object({
    create: z
      .union([
...
export const TagUncheckedUpdateManyWithoutOrgNestedInputObjectSchema = Schema;

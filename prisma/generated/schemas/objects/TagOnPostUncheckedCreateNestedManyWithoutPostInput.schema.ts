...
const Schema: z.ZodType<Prisma.TagOnPostUncheckedCreateNestedManyWithoutPostInput> =
  z
    .object({
      create: z
        .union([
...
export const TagOnPostUncheckedCreateNestedManyWithoutPostInputObjectSchema =
  Schema;

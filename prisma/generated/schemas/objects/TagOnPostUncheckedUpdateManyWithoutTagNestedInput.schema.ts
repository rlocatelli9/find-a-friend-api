...
const Schema: z.ZodType<Prisma.TagOnPostUncheckedUpdateManyWithoutTagNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => TagOnPostUpsertWithWhereUniqueWithoutTagInputObjectSchema,
          ),
          z
            .lazy(
              () => TagOnPostUpsertWithWhereUniqueWithoutTagInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => TagOnPostUpdateWithWhereUniqueWithoutTagInputObjectSchema,
          ),
          z
            .lazy(
              () => TagOnPostUpdateWithWhereUniqueWithoutTagInputObjectSchema,
...
export const TagOnPostUncheckedUpdateManyWithoutTagNestedInputObjectSchema =
  Schema;

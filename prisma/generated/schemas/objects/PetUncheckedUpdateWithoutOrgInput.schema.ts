...
import { PostUncheckedUpdateManyWithoutPetNestedInputObjectSchema } from './PostUncheckedUpdateManyWithoutPetNestedInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.PetUncheckedUpdateWithoutOrgInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    deleted_at: z
      ...
      .nullable(),
    posts: z
      .lazy(() => PostUncheckedUpdateManyWithoutPetNestedInputObjectSchema)
      .optional(),
  })
  .strict();

export const PetUncheckedUpdateWithoutOrgInputObjectSchema = Schema;

...
const Schema: z.ZodType<Prisma.PostUncheckedUpdateManyWithoutPetNestedInput> = z
  .object({
    create: z
      .union([
...
export const PostUncheckedUpdateManyWithoutPetNestedInputObjectSchema = Schema;

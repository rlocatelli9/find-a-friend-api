...
const Schema: z.ZodType<Prisma.TagOnPostUpdateManyWithoutPostNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => TagOnPostUpdateManyWithWhereWithoutPostInputObjectSchema),
        z
          .lazy(() => TagOnPostUpdateManyWithWhereWithoutPostInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const TagOnPostUpdateManyWithoutPostNestedInputObjectSchema = Schema;

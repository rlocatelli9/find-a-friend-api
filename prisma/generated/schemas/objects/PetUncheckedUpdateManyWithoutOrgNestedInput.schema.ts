...
const Schema: z.ZodType<Prisma.PetUncheckedUpdateManyWithoutOrgNestedInput> = z
  .object({
    create: z
      .union([
...
export const PetUncheckedUpdateManyWithoutOrgNestedInputObjectSchema = Schema;

...
const Schema: z.ZodType<Prisma.PostUncheckedUpdateManyWithoutOrgNestedInput> = z
  .object({
    create: z
      .union([
...
export const PostUncheckedUpdateManyWithoutOrgNestedInputObjectSchema = Schema;

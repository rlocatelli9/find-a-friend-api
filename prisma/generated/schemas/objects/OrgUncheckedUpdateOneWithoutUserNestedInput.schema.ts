...
const Schema: z.ZodType<Prisma.OrgUncheckedUpdateOneWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
...
export const OrgUncheckedUpdateOneWithoutUserNestedInputObjectSchema = Schema;
